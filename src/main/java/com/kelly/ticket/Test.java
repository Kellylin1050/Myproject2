...
public class Test {
    public static void main(String[] args) {
        ...
        Ticket ticket1 = new Ticket(type);
        System.out.println(ticket.start.name + "\t" + ticket.destination.name + "\t" + "Type:" + ticket1.type.name + "\t" + "ticket:" + quantity + "\t" + "price:" + price * quantity);
    }
}
